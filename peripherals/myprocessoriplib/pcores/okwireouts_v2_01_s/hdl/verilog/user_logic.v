...
// Date:              Wed May 24 12:51:25 2017 (by Create and Import Peripheral Wizard)
...
//----------------------------------------------------------------------------
  ...
  okWireOut wireout00 (.okHE(okHE), .okEH(okEHx[0*65 +: 65]), .ep_addr(8'h20), .ep_datain(slv_reg0));
  okWireOut wireout01 (.okHE(okHE), .okEH(okEHx[1*65 +: 65]), .ep_addr(8'h21), .ep_datain(slv_reg1));
  okWireOut wireout02 (.okHE(okHE), .okEH(okEHx[2*65 +: 65]), .ep_addr(8'h22), .ep_datain(slv_reg2));
  okWireOut wireout03 (.okHE(okHE), .okEH(okEHx[3*65 +: 65]), .ep_addr(8'h23), .ep_datain(slv_reg3));
  okWireOut wireout04 (.okHE(okHE), .okEH(okEHx[4*65 +: 65]), .ep_addr(8'h24), .ep_datain(slv_reg4));
  okWireOut wireout05 (.okHE(okHE), .okEH(okEHx[5*65 +: 65]), .ep_addr(8'h25), .ep_datain(slv_reg5));
  okWireOut wireout06 (.okHE(okHE), .okEH(okEHx[6*65 +: 65]), .ep_addr(8'h26), .ep_datain(slv_reg6));
  okWireOut wireout07 (.okHE(okHE), .okEH(okEHx[7*65 +: 65]), .ep_addr(8'h27), .ep_datain(slv_reg7));
  okWireOut wireout08 (.okHE(okHE), .okEH(okEHx[8*65 +: 65]), .ep_addr(8'h28), .ep_datain(slv_reg8));
  okWireOut wireout09 (.okHE(okHE), .okEH(okEHx[9*65 +: 65]), .ep_addr(8'h29), .ep_datain(slv_reg9));
  okWireOut wireout10 (.okHE(okHE), .okEH(okEHx[10*65 +: 65]), .ep_addr(8'h2a), .ep_datain(slv_reg10));
  okWireOut wireout11 (.okHE(okHE), .okEH(okEHx[11*65 +: 65]), .ep_addr(8'h2b), .ep_datain(slv_reg11));
  okWireOut wireout12 (.okHE(okHE), .okEH(okEHx[12*65 +: 65]), .ep_addr(8'h2c), .ep_datain(slv_reg12));
  okWireOut wireout13 (.okHE(okHE), .okEH(okEHx[13*65 +: 65]), .ep_addr(8'h2d), .ep_datain(slv_reg13));
  okWireOut wireout14 (.okHE(okHE), .okEH(okEHx[14*65 +: 65]), .ep_addr(8'h2e), .ep_datain(slv_reg14));
  okWireOut wireout15 (.okHE(okHE), .okEH(okEHx[15*65 +: 65]), .ep_addr(8'h2f), .ep_datain(slv_reg15));
  okWireOut wireout16 (.okHE(okHE), .okEH(okEHx[16*65 +: 65]), .ep_addr(8'h30), .ep_datain(slv_reg16));
  okWireOut wireout17 (.okHE(okHE), .okEH(okEHx[17*65 +: 65]), .ep_addr(8'h31), .ep_datain(slv_reg17));
  okWireOut wireout18 (.okHE(okHE), .okEH(okEHx[18*65 +: 65]), .ep_addr(8'h32), .ep_datain(slv_reg18));
  okWireOut wireout19 (.okHE(okHE), .okEH(okEHx[19*65 +: 65]), .ep_addr(8'h33), .ep_datain(slv_reg19));
  okWireOut wireout20 (.okHE(okHE), .okEH(okEHx[20*65 +: 65]), .ep_addr(8'h34), .ep_datain(slv_reg20));
  okWireOut wireout21 (.okHE(okHE), .okEH(okEHx[21*65 +: 65]), .ep_addr(8'h35), .ep_datain(slv_reg21));
  okWireOut wireout22 (.okHE(okHE), .okEH(okEHx[22*65 +: 65]), .ep_addr(8'h36), .ep_datain(slv_reg22));
  okWireOut wireout23 (.okHE(okHE), .okEH(okEHx[23*65 +: 65]), .ep_addr(8'h37), .ep_datain(slv_reg23));
  okWireOut wireout24 (.okHE(okHE), .okEH(okEHx[24*65 +: 65]), .ep_addr(8'h38), .ep_datain(slv_reg24));
  okWireOut wireout25 (.okHE(okHE), .okEH(okEHx[25*65 +: 65]), .ep_addr(8'h39), .ep_datain(slv_reg25));
  okWireOut wireout26 (.okHE(okHE), .okEH(okEHx[26*65 +: 65]), .ep_addr(8'h3a), .ep_datain(slv_reg26));
  okWireOut wireout27 (.okHE(okHE), .okEH(okEHx[27*65 +: 65]), .ep_addr(8'h3b), .ep_datain(slv_reg27));
  okWireOut wireout28 (.okHE(okHE), .okEH(okEHx[28*65 +: 65]), .ep_addr(8'h3c), .ep_datain(slv_reg28));
  okWireOut wireout29 (.okHE(okHE), .okEH(okEHx[29*65 +: 65]), .ep_addr(8'h3d), .ep_datain(slv_reg29));
  okWireOut wireout30 (.okHE(okHE), .okEH(okEHx[30*65 +: 65]), .ep_addr(8'h3e), .ep_datain(slv_reg30));
  okWireOut wireout31 (.okHE(okHE), .okEH(okEHx[31*65 +: 65]), .ep_addr(8'h3f), .ep_datain(slv_reg31));
