...
Project.filter<0>=
Project.filter<1>=statadc
Project.filter<2>=fifo_4kB
Project.filter<3>=valid
Project.filter<4>=fifo_dout_valid
...
Project.unit<0>.dataChannel<0>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.gl0.rd/gr1.rfwft/user_valid
...
Project.unit<0>.dataChannel<1>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<7>
...
Project.unit<0>.dataChannel<2>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<6>
...
Project.unit<0>.dataChannel<3>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<5>
Project.unit<0>.dataChannel<40>=fifo_inst_4kB din<0>
Project.unit<0>.dataChannel<41>=fifo_inst_4kB wr_en
Project.unit<0>.dataChannel<42>=imager_time/FSMIND0_i
Project.unit<0>.dataChannel<43>=imager_time/FSMIND1ACK_i
Project.unit<0>.dataChannel<4>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<4>
Project.unit<0>.dataChannel<5>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<3>
Project.unit<0>.dataChannel<6>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<2>
Project.unit<0>.dataChannel<7>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<1>
Project.unit<0>.dataChannel<8>=fifo_inst_4kB U0/xst_fifo_generator/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.mem/dout_i<0>
...
Project.unit<0>.triggerChannel<4><0>=imager_time/FSMIND0_i
Project.unit<0>.triggerChannel<5><0>=imager_time/FSMIND1ACK_i
