...
xst -ifn xst.scr
move test_freqchng_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\test_freqchng_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc test_freqchng_dcm_exdes.ucf test_freqchng_dcm_exdes

echo 'Running map'
map -timing -pr b test_freqchng_dcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm test_freqchng_dcm_exdes -w routed.ncd routed.v
cd ..
