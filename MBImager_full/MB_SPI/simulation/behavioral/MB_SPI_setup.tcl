...
#
#  File     MB_SPI_setup.tcl (Tue Dec 06 14:47:35 2016)
#
...
#  with the '-tclbatch MB_SPI_setup.tcl' option.
...
proc PrintHelpInformation {} {
  ...
  puts "**********************************************************************"
  puts "***"
  puts "***   Simulation Setup Macros (MB_SPI_setup.tcl)"
  puts "***"
  puts "***   w   =>  set up signal tracing for the ISE Simulator waveform"
  puts "***           viewer (edit signal lists in MB_SPI_wave.tcl)"
  puts "***"
