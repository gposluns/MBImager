...
xst -ifn xst.scr
move CLK_DDR_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_DDR_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_DDR_exdes.ucf CLK_DDR_exdes

echo 'Running map'
map -timing -pr b CLK_DDR_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm CLK_DDR_exdes -w routed.ncd routed.v
cd ..
