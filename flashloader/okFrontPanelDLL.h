...
// $Rev: 2197 $ $Date: 2014-07-24 09:18:05 -0700 (Thu, 24 Jul 2014) $
//------------------------------------------------------------------------
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetFPGAResetProfileWithSize(okFrontPanel_HANDLE hnd, okEFPGAConfigurationMethod method, okTFPGAResetProfile *profile, unsigned size);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetFPGAResetProfileWithSize(okFrontPanel_HANDLE hnd, okEFPGAConfigurationMethod method, const okTFPGAResetProfile *profile, unsigned size);
